...
export default function ITServicesPage() {
    ...
    const services = [
        ...
        {
            title: "IT Consulting",
            description: "Strategic technology guidance to help your business thrive in the digital age.",
            icon: "💡",
        },
    ];
        ...
        <>
            ...
            <div className="w-full min-h-screen bg-white">
                ...
                <section
                    ...
                    style={{ background: 'linear-gradient(135deg, #b7120e 0%, #b52914 100%)' }}
                >
                    <div className="container mx-auto px-6 py-20 text-center">
                        ...
                        <p
                            ...
                            style={{ fontFamily: "'NeueMontreal', sans-serif" }}
                        >
                            Our creative team transforms ideas into stunning digital solutions that captivate your audience and elevate your brand.
                        </p>
                    </div>
